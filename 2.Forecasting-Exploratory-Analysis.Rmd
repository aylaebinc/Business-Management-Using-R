...
qplot(WEB,TRAIN,data = ts_merged_article_sales_chanel) +
  ylab("TRAIN") +
  xlab("WEB")
```
...
# And plot this matrix using corrplot() from corrplot package
corrplot(cor_matrix,method = "number",
type = "upper")

# The same corrplot but in a form of color heat map 
...
Autocorrelation is one of the fundamental ideas in time series analysis.
